...
class logoutt(TestCase):
    ...
    def test_addNewAccountForUser(self):
        ...
        print(actual_title)
        driver.find_element(By.ID, Register.Firstname).send_keys("Rishabh")
        ...
        driver.find_element(By.ID, Register.customeruser).send_keys("Ram")
        driver.find_element(By.ID, Register.customerpass).send_keys("Rii")
        driver.implicitly_wait(5)
        driver.find_element(By.ID, Register.repeatedpass).send_keys("Rii")
        driver.implicitly_wait(5)
